...
export default function PricingCard() {
  return (
    <div className="flex flex-col border w-[800px] rounded-lg hover:scale-105 transition-all duration-200">
      ...
      <div className="flex w-[100%]">
        ...
        <div className="w-[50%] border flex-col p-6">
          ...
          <div className="flex flex-col my-10">
            ...
            <Button className="my-1 h-14 bg-slate-600">Free 7 day trial</Button>
          </div>
          <ul>
            <li className="my-1">Unlimited devices</li>
            <li className="my-1">Unlimited password</li>
